...
<body class="main-body leftmenu">
									...
									<form>
										...
										<div class="Remuneraciones mt-4 d-none">
											<div class="row">
												...
												<div class="col-lg-6">
													<div class="form-group select2-lg">
														<label for="">Tipo de Sueldo Base:</label>
												...
												<div class="col-lg-6">
													<div class="form-group select2-lg">
														...
														<select id="formapago" onchange="detigra()" name="formapago" required="" class="form-control">
															<option value="1" data-content="Las partes no pactan un sistema de pago de gratificación. Tener presente que en caso de ser de aquellas empresas señaladas en el artículo 47 del Código del Trabajo y obtener utilidades líquidas en su giro, tendrá la obligación de pagar esa.">No pactado en contrato de trabajo</option>
															<option value="2" data-content="Gratificación no inferior al 30% de las utilidades de la empresa en el año anterior.">Artículo 47 del Código del Trabajo</option>
															<option value="3" data-content="Es aquella pactada por las partes en el contrato individual o en instrumento colectivo y que sean superiores a las que resultan de la aplicación del artículo 47 o 50 del Código del Trabajo..">Modalidad convencional superior al mínimo legal</option>
															<option value="4" data-content="Gratificación del 25% de lo percibido por el trabajador, con un máximo de 4.75 IMM al año.">Artíuculo 50 del Código del Trabajo</option>
															<option value="5" selected data-content="No tiene obligación legal de pagar gratificación.">Sin obligación legal de pago</option>
														</select>
													</div>
												</div>
										...
										<div class="jornada mt-4 d-none">
											...
											<div class="row">
												<div class="col-md-12 d-flex justify-content-between">
													...
													<button type="button" class="btn btn-primary btn-sm pl-4 pr-4" onclick="RegistrarContrato()">Registrar <i class="fa fa-arrow-right"></i></button>
	...
	<script src="JsFunctions/contratoexpress.js"></script>
	<?php
