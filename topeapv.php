...
<head>
    ...
    <!-- Title -->
    <title>Gestor de Documentos | TOPE APV MENSUAL</title>
...
<body class="main-body leftmenu">
                ...
                <div class="inner-body">
                    ...
                    <div class="page-header">
                        <div class="page-header-1">
                            <h1 class="main-content-title tx-30">TOPE APV MENSUAL</h1>
                            <ol class="breadcrumb">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card orverflow-hidden">
                                <div class="card-body">
                                    <div>
                                        <h6 class="main-content-label mb-1">Registro de TOPE APV MENSUAL</h6>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group has-success mg-b-0">
                                                    <label>PERIODO</label>
                                                    <input class="form-control" id="periodo" name="periodo" required="" type="month" value="<?php echo date("Y-m"); ?>">
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group has-success mg-b-0">
                                                    <label>TOPE</label>
                                                    <input class="form-control" id="tope" name="tope" required="" type="text" value="" placeholder="Ingrese La Tope">
                                                </div>
                                            </div>
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12">
                            <div class="card transcation-crypto1" id="transcation-crypto1">
                                <div class="card-header bd-b-0">
                                    <h4 class="card-title font-weight-semibold mb-0">Listado  TOPE APV MENSUAL</h4>
                                </div>
                                <div class="card-body">
                                    <div class="">
                                            ...
                                            <table class="table w-100 text-wrap" id="example1">
                                                <thead class="border-top text-center">
                                                    <tr>
                                                        ...
                                                        <th class="bg-transparent">TOPE</th>
                                                        <th class="bg-transparent">Acciones</th>
                                                    </tr>
                                                </thead>
                                                <tbody class="text-center">
                                                    <?php
                                                    $lista = $c->listartopeapvmensual();
                                                    if (count($lista) > 0) {
                                                        foreach ($lista as $object) {
                                                            ...
                                                            echo "<tr>";
                                                            echo "<td>" . $periodo . "</td>";
                                                            echo "<td>" . number_format($object->getTasa(), 3, ",", ".") . "</td>";
                                                            echo "<td>";
                                                            echo "<a href='javascript:void(0)' onclick='editar(" . $object->getId() . ",\"" . $object->getPeriodo() . "\"," . $object->getTasa() . ")' class='btn btn-primary btn-sm'><i class='fa fa-edit'></i></a>";
                                                            echo " <a href='javascript:void(0)' onclick='eliminar(" . $object->getId() . ")' class='btn btn-danger btn-sm'><i class='fa fa-trash'></i></a>";
                                                            echo "</td>";
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="staticBackdropLabel">Editar TOPE APV MENSUAL</h5>
                    ...
                    <div class="modal-body">
                        <form id="formedit">
                            <div class="row">
                                <div class="col-lg-6">
                                        <input class="form-control" id="idedit" name="idedit" required="" type="hidden" value="">
                                    <div class="form-group has-success mg-b-0">
                                        <label>Periodo</label>
                                        <input class="form-control" id="periodoedit" name="periodoedit" required="" type="month" value="<?php echo date("Y-m"); ?>">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group has-success mg-b-0">
                                        <label>Tope</label>
                                        <input class="form-control" id="topeedit" name="topeedit" required="" type="text" value="" placeholder="Ingrese el Tope">
                                    </div>
                                </div>
                                <div class="col-md-12 mt-3 text-right">
                                    <button type="submit" href="#" class="btn btn-primary btn-md"> <i class="fa fa-refresh"></i> Actualizar</button>
                                </div>
                            </div>
                        </form>
                    </div>
    ...
    <script>
        ...
        let myNumericInput = new AutoNumeric(('#tope'), {
            decimalPlaces: 3,
            digitGroupSeparator: '.',
            decimalCharacter: ',',
            minimumValue: '0'
        ...
        document.querySelector('#tope').addEventListener('keyup', function(event) {});
        
        let myNumericInput1 = new AutoNumeric(('#topeedit'), {
            decimalPlaces: 3,
            digitGroupSeparator: '.',
            decimalCharacter: ',',
            minimumValue: '0'
        ...
        document.querySelector('#topeedit').addEventListener('keyup', function(event) {});
    }
    formatearnumero();
    </script>
    <script src="JsFunctions/topeapv.js"></script>
