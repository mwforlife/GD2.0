				...
				<div class="inner-body">
					...
					<div class="page-header">
						<div class="page-header-1">
							<h1 class="main-content-title tx-30">Licencia Medica</h1>
							<ol class="breadcrumb">
						...
						<div class="col-lg-12">
							<div class="card">
								<div class="card-body">
									...
									<form id="LicenciaFormEdit" name="LicenciaFormEdit">

										<div class="row">
											<div class="col-md-6">
												<label>FOlIO</label>
												<input type="text" placeholder="Ingrese el Folio" required class="form-control text-dark" id="folio" name="folio" value="<?php if ($prev != null) {
																																												echo $prev->getFolio();
																																											} ?>">
											</div>
											<div class="col-md-6">
												<label>Tipo de Licencia</label>
												<select class="form-control text-dark" required id="tipolicencia" name="tipolicencia">
													<?php if ($prev != null) {
														if ($prev->getTipolicencia() == 1) {
															echo '<option value="1" selected>Orden de reposo</option>';
															echo '<option value="2">Maternal (Pre y Post)</option>';
															echo '<option value="3">Licencias Medicas</option>';
														} else if ($prev->getTipolicencia() == 2) {
															echo '<option value="1">Orden de reposo</option>';
															echo '<option value="2" selected>Maternal (Pre y Post)</option>';
															echo '<option value="3">Licencias Medicas</option>';
														} else if ($prev->getTipolicencia() == 3) {
															echo '<option value="1">Orden de reposo</option>';
															echo '<option value="3" selected>Licencias Medicas</option>';
															echo '<option value="2">Maternal (Pre y Post)</option>';
														}
													} else { ?>
														<option value="1">Orden de reposo</option>
														<option value="2">Maternal (Pre y Post)</option>
														<option value="3">Licencias Medicas</option>
													<?php } ?>
												</select>
											</div>
											<div class="col-md-6">
												<label>Fecha Inicio</label>
												<input type="date" required onchange="calcular()" class="form-control text-dark" id="fechainicio" name="fechainicio" value="<?php if ($prev != null) {
																																												echo $prev->getFechainicio();
																																											} ?>">
												<input type="hidden" required id="id" name="id" value="<?php if ($prev != null) {
																											echo $prev->getId();
																										} ?>">
											</div>
											<div class="col-md-6">
												<label>Fecha Termino</label>
												<input type="date" required onchange="calcular()" class="form-control text-dark" id="fechatermino" name="fechatermino" value="<?php if ($prev != null) {
																																													echo $prev->getFechafin();
																																												} ?>">
											</div>
											<div class="col-md-6">
												<label>Cantidad de Días</label>
												<input type="text" readonly required class="form-control text-dark" id="cantidaddias" name="cantidaddias" value="<?php if ($prev != null) {
																																										echo $prev->getFechafin();
																																									} ?>">
											</div>
											<div class="col-md-6">
												<label>Institucion Pagadora</label>
												<select class="form-control text-dark" required id="TrabajadorAfp" name="TrabajadorAfp">
													<?php
													$afps = $c->listarpagadores();
													if (count($afps) > 0) {
														foreach ($afps as $l) {
															if ($prev != null) {
																if ($prev->getPagadora() == $l->getId()) {
														...
														echo "<option value='0'>No hay Institucion Registradas</option>";
													}
													?>
												</select>
											</div>
										...
										<div class="row">
													...
													<div class="card-body">
														...
														<div class="row">
															<div class="col-sm-12 col-md-12">
																<input class="form-control" maxlength="200" type="text" name="comentario" id="comentario" placeholder="Observacion" value="<?php if ($prev != null) {
											...
											<div class="col-lg-6 col-md-6">
												<div class="card">
													<div class="card-body">
														<div>
															<h6 class="main-content-label mb-1">Cargar Documento de licencia</h6>
														</div>
														<div class="row">
															<div class="col-sm-12 col-md-12">
																<input type="file" name="documentolicencia" id="documentolicencia" class="dropify" data-height="200" <?php
																																										if ($prev != null) {
																																											//CARGAR DOCUMENTO al input file dropify

																																											$documento = $prev->getDocumentolicencia();
																																											$carpeta = "uploads/";
											...
											<div class="col-lg-6 col-md-6">
												<div class="card">
													<div class="card-body">
														<div>
															<h6 class="main-content-label mb-1">Cargar Comprobante de tramicacion</h6>
														</div>
														<div class="row">
															<div class="col-sm-12 col-md-12">
																<input type="file" name="comprobantetramite" id="comprobantetramite" class="dropify" data-height="200" <?php
																																										if ($prev != null) {
																																											//CARGAR DOCUMENTO al input file dropify

																																											$documento = $prev->getComprobantetramite();
																																											$carpeta = "uploads/";
																																											$directorio = opendir($carpeta);
																																											while ($archivo = readdir($directorio)) {
																																												if (!is_dir($archivo)) {
