$(document).ready(function(){
    $("#RegisForm").on("submit", function(e){
        ...
        $.ajax({
            type: "POST",
            url: "php/insert/pagadoressubsidio.php",
            data: data,
...
function Editar(id){
    ...
    $.ajax({
        type: "POST",
        url: "php/cargaredit/pagadoressubsidio.php",
        data: {id: id},
        success: function(data){
            $("#global-loader").fadeOut("slow");
            $(".content").html(data);            
...
function Actualizar(id){
    ...
    $.ajax({
        type: "POST",
        url: "php/update/pagadoressubsidio.php",
...
function Eliminar(id){
    ...
    swal.fire({
        ...
        if (result.value) {
            $.ajax({
                type: "POST",
                url: "php/eliminar/pagadoressubsidio.php",
                data: {id: id},
                success: function(data){
                    $("#global-loader").fadeOut("slow");
                    if(data == 1 || data == "1"){
