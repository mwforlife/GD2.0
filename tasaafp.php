...
if(isset($_GET['code'])){
    $code = $_GET['code'];
    $nombre = "";
    $afp = $c->buscarafp($code);
    if($c->buscarafp($code)==null){
				...
				<div class="inner-body">
					...
					<div class="page-header">
						<div class="page-header-1">
							<h1 class="main-content-title tx-30 tx-uppercase"><?php echo $nombre;?></h1>
							<ol class="breadcrumb">
								...
								<div class="card-body">
									<div>
                                        ...
                                        <div class="col-md-12 mt-3 text-right">
                                            <a class="btn btn-danger" href="afp.php"> <i class="fa fa-arrow-left"></i> Volver</a>
