				...
				<div class="inner-body">
					...
					<div class="page-header">
						<div class="page-header-1">
							<h1 class="main-content-title tx-30">Carga Familiar</h1>
							<ol class="breadcrumb">
					...
					<div class="row ">
						<div class="col-lg-12">
							<div class="card">
								<div class="card-body">
									<form id="CargaForm" name="CargaForm">
										<div class="row">
											<div class="col-md-6">
												<label>RUT</label>
												<input type="text" placeholder="11.111.111-1" required onkeyup="formatRut(this)" class="form-control text-dark text-dark" id="rut" name="rut" value="">
											</div>
											<div class="col-md-6">
												<label>Nombres</label>
												<input type="text" placeholder="Nombres" required class="form-control text-dark text-dark" id="nombre" name="nombre" value="">
											</div>
											<div class="col-md-6">
												<label>Primer Apellido</label>
												<input type="text" placeholder="Primer Apellido" required class="form-control text-dark text-dark" id="apellido1" name="apellido1" value="">
											</div>
											<div class="col-md-6">
												<label>Segundo Apellido</label>
												<input type="text" placeholder="Segundo Apellido" class="form-control text-dark text-dark" id="apellido2" name="apellido2" value="">
											</div>
											<div class="col-md-6">
												<label>Fecha de Nacimiento</label>
												<input type="date" class="form-control text-dark text-dark" required id="nacimiento" name="nacimiento" value="">
											</div>
											<div class="col-md-6">
											...
											<div class="col-md-6">
												...
												<input type="date" class="form-control text-dark text-dark" required id="reconocimiento" name="reconocimiento" value="">
											</div>
											<div class="col-md-6">
												<label>Fecha Pago</label>
												<input type="date" class="form-control text-dark text-dark" required id="pago" name="pago" value="">
											</div>
											<div class="col-md-6">
												<label>Vigencia Hasta</label>
												<input type="date" class="form-control text-dark text-dark" id="vigencia" name="vigencia" value="">
											</div>
											<div class="col-md-6">
											...
											<div class="col-lg-12 col-md-12">
												<div class="card">
													<div class="card-body">
														<div>
															<h6 class="main-content-label mb-1">Observacion</h6>
														</div>
														<div class="row">
