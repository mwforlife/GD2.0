                ...
                <div class="inner-body">
                    ...
                    <div class="page-header">
                        <div class="page-header-1">
                            <h1 class="main-content-title tx-30">Generación de documento individual</h1>
                            <ol class="breadcrumb">
                                ...
                                <div class="card-body">
                                    <form id="formdocumento" name="formdocumento">
                                        ...
                                        <div class="col-md-12 mt-3 text-right">
                                            ...
                                            <button type="button" id="previadocumento" class="btn btn-warning"> <i class="fa fa-eye"></i> Vista Previa</button>
                                ...
                                <div class="card-body p-4 pt-1">
                                    <div class="p-4">
                                        <div class="table-responsive">
                                            <table class="table w-100 text-wrap w-100" id="example1">
