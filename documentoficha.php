						...
						<div class="col-lg-12">
							<div class="card">
								<div class="card-body">
									...
									<form id="documentoform" name="documentoform">

										<div class="row">
											<div class="col-md-6">
												<label>Titulo del Documento</label>
												<input type="text" required class="form-control text-dark" placeholder="Titulo de Documento" id="titulo" name="titulo" value="">
											</div>
											<div class="col-md-6">
												...
												<select name="tipo" id="tipo" class="form-control" required>
													...
													<option value="3">Anexo de Contrato</option>
													<option value="4">Finiquito</option>
													<option value="5">Carta de Renuncia</option>
													<option value="6">Carta de Despido</option>
													<option value="7">Carta de Aviso</option>
													<option value="8">Entrega de EPP</option>
												</select>
													...
													<div class="card-body">
														...
														<div class="row">
															<div class="col-sm-12 col-md-12">
																<input class="form-control" maxlength="200" type="text" name="comentario" id="comentario" placeholder="Observacion" value="" />
															</div>
														</div>
													</div>
												</div>
