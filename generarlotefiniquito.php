                ...
                <div class="inner-body">
                    ...
                    <div class="page-header">
                        <div class="page-header-1">
                            <h1 class="main-content-title tx-30">Generar Finiquitos Masivos</h1>
                            <ol class="breadcrumb">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card orverflow-hidden">
                                <div class="card-body">
                                    <div>
                                        <h6 class="main-content-label mb-1">Seleccione los Contratos a Finiquitar</h6>
                            ...
                            <div class="card orverflow-hidden">
                                <div class="card-body">
                                    <div class="d-flex justify-content-center">
                                        <a href="finiquitosmasivos.php" class="btn btn-success">Generar Finiquitos <i class="fa fa-file"></i></a>
                                    </div>
                                </div>
