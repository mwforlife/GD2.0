				...
				<div class="inner-body">
					...
					<div class="row">
						<div class="col-md-6 text-left mb-2">
							<a href="generarlotenotificacion.php" class="btn btn-md btn-warning">Notificación Masiva <i class="fa fa-file"></i> </a>
						</div>
					</div>
					<!-- ROW- opened -->
					<div class="row">
						<div class="col-xl-12 col-lg-12 col-md-12">
							<div class="card transcation-crypto1" id="transcation-crypto1">
								<div class="card-header bd-b-0">
									<h4 class="card-title font-weight-semibold mb-0">Listado de Trabajadores Finiquitados</h4>
								</div>
											...
											<table class="table text-nowrap w-100" id="example1">
												<thead class="border-top">
													<tr>
														...
														<th class="bg-transparent text-center">Generar Notificacion</th>
													</tr>
												</thead>
												<tbody>
													<?php
													$lista = $c->listartrabajadoresfiniquitados($_SESSION['CURRENT_ENTERPRISE']);
	...
	<script>
		...
		function mas1(id) {
			$.ajax({
				...
				success: function(data) {
					window.location.href = "notificacionindividual.php";
				}
			});
		}
	</script>
