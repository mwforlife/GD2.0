...
<head>
	...
	<!-- Title -->
	<title>Gestor de Documentos | Seguro Social / Expectativa de Vida</title>
...
<body class="main-body leftmenu">
	...
	<div class="page">
				...
				<div class="inner-body">
					...
					<div class="page-header">
						<div class="page-header-1">
							<h1 class="main-content-title tx-30">Seguro Social / Rentabilidad Protegida</h1>
							<ol class="breadcrumb">
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="card orverflow-hidden">
								<div class="card-body">
									<div>
										<h6 class="main-content-label mb-1">Registro de Seguro Social / Rentabilidad Protegida</h6>
										...
										<div class="row">
											<div class="col-lg-6">
												<div class="form-group has-success mg-b-0">
													...
													<input class="form-control" id="Codigo" name="Codigo" placeholder="Codigo" type="text" value="">
												</div>
											</div>
											<div class="col-lg-6">
												<div class="form-group has-success mg-b-0">
													<label>Codigo (PREVIRED)</label>
													<input class="form-control" id="CodigoPrevired" name="CodigoPrevired" placeholder="Codigo (PREVIRED)" type="text" value="">
												</div>
											</div>
											<div class="col-lg-6">
												<div class="form-group has-success mg-b-0">
													<label>Periodo</label>
													<input class="form-control" id="periodo" name="PeriodoNombre" placeholder="Nombre Seguro Social / Expectativa de Vida" required="" type="month" value="">
												</div>
											</div>
											<div class="col-lg-6">
												<div class="form-group has-success mg-b-0">
													<label>Tasa</label>
													<input class="form-control" id="tasa" name="Tasa" placeholder="Tasa Seguro Social / Expectativa de Vida" required="" type="text" value="">
												</div>
											</div>
						...
						<div class="col-xl-12 col-lg-12 col-md-12">
							<div class="card transcation-crypto1" id="transcation-crypto1">
								<div class="card-header bd-b-0">
									<h4 class="card-title font-weight-semibold mb-0">Tasa Seguro Social / Rentabilidad Protegida</h4>
								</div>
								<div class="card-body">
									<div class="">
		...
		<div class="main-footer text-center">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<span>Copyright © <?php echo date('Y'); ?>- ApoyoContadores. Todos los derechos reservados.</span>
					</div>
				</div>
			</div>
		</div>
	...
	<!-- <script src="assets/js/table-data.js"></script> Comentado para evitar conflicto con inicialización dinámica -->
	...
	<script src="JsFunctions/segurosocial.js"></script>
