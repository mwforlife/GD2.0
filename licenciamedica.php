			...
			<div class="main-sidebar-body">
				<ul class="nav">
					...
					<li class="nav-item">
						...
						<ul class="nav-sub">
							<li class="nav-sub-item">
								<a class="nav-sub-link" href="generarlote.php">Generacion de Documentos Masivos</a>
							</li>
							<li class="nav-sub-item">
						...
						<div class="col-lg-12">
							<div class="card">
								<div class="card-body">
									...
									<form id="LicenciaForm" name="LicenciaForm">

										<div class="row">
											<div class="col-md-6">
												<label>FOlIO</label>
												<input type="text" placeholder="Ingrese el Folio" required class="form-control text-dark" id="folio" name="folio" value="">
											</div>
											<div class="col-md-6">
												...
												<select class="form-control text-dark" required id="tipolicencia" name="tipolicencia">
													...
													<option value="3" selected>Licencias Medicas</option>
												</select>
											</div>
											<div class="col-md-6">
												<label>Fecha Inicio</label>
												<input type="date" onchange="calcular()" required class="form-control text-dark" id="fechainicio" name="fechainicio" value="">
											</div>
											<div class="col-md-6">
												<label>Fecha Termino</label>
												<input type="date" onchange="calcular()" required class="form-control text-dark" id="fechatermino" name="fechatermino" value="">
											</div>
											<div class="col-md-6">
										...
										<div class="row">
											...
											<div class="col-lg-6 col-md-6">
												<div class="card">
													<div class="card-body">
														...
														<div class="row">
															<div class="col-sm-12 col-md-12">
																<input type="file" name="documentolicencia" id="documentolicencia" class="dropify" data-height="200" required />
															</div>
														</div>
													</div>
												</div>
											...
											<div class="col-lg-6 col-md-6">
												<div class="card">
													<div class="card-body">
														<div>
															<h6 class="main-content-label mb-1">Cargar Comprobante de tramitación</h6>
														</div>
														<div class="row">
															<div class="col-sm-12 col-md-12">
																<input type="file" name="comprobantetramite" id="comprobantetramite" class="dropify" data-height="200" required />
															</div>
														</div>
													</div>
												</div>
