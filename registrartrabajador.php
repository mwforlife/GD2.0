				...
				<div class="inner-body">
					...
					<div class="page-header">
						<div class="page-header-1">
							<h1 class="main-content-title tx-30">Registro de Trabajador</h1>
							<ol class="breadcrumb">
						...
						<div class="col-lg-12">
							<div class="card orverflow-hidden">
								<div class="card-body">
									...
									<form id="TrabajadorForm" name="TrabajadorForm" action="" class="needs-validation was-validated">
										<div class="row">
											<div class="col-lg-6">
											...
											<div class="col-lg-6">
												<div class="form-group has-success ">
													<label for="">DNI:</label>
													<input class="form-control" placeholder="DNI" id="TrabajadorDNI" name="TrabajadorDNI" type="text" value="">
												</div>
											</div>
											<div class="col-lg-6">
												<div class="form-group has-success ">
													<label for="">Nombre:</label>
													<input class="form-control" placeholder="Nombre" id="TrabajadorNombre" name="TrabajadorNombre" required="" type="text" value="">
												</div>
											</div>
											<div class="col-lg-6">
												<div class="form-group has-success ">
													...
													<input class="form-control" placeholder="Primer Apellido" id="TrabajadorApellido1" name="TrabajadorApellido1" required="" type="text" value="">
												</div>
											</div>
											<div class="col-lg-6">
												<div class="form-group has-success ">
													<label for="">Segundo Apellido:</label>
													<input class="form-control" placeholder="Segundo Apellido" id="TrabajadorApellido2" name="TrabajadorApellido2" type="text" value="">
												</div>
											</div>
											<div class="col-lg-6">
												<div class="form-group has-success ">
													<label for="">Fecha de Nacimiento:</label>
													<input class="form-control" placeholder="Fecha de Nacimiento" id="TrabajadorNacimiento" name="TrabajadorNacimiento" required="" type="date" value="">
												</div>
											</div>
											<div class="col-lg-6">
												<div class="form-group select2-lg">
													<label for="">Sexo:</label>
													<select id="TrabajadorSexo" name="TrabajadorSexo" required="" class="form-control ">
											...
											<div class="col-lg-6">
												<div class="form-group select2-lg">
													...
													<select id="TrabajadorCivil" name="TrabajadorCivil" required="" class="form-control ">
														<?php
											...
											<div class="col-lg-6">
												<div class="form-group select2-lg">
													...
													<select id="TrabajadorNacionalidad" name="TrabajadorNacionalidad" required="" class="form-control ">
														<?php
											...
											<div class="col-lg-6">
												<div class="form-group select2-lg">
													...
													<select id="TrabajadorDiscapacidad" name="TrabajadorDiscapacidad" required="" class="form-control ">
											...
											<div class="col-lg-6">
												<div class="form-group select2-lg">
													...
													<select id="TrabajadorPension" name="TrabajadorPension" required="" class="form-control ">
														<option value="2">No</option>
														<option value="1">Si</option>
													</select>
												</div>
										...
										<div class="row">
											...
											<div class="col-lg-6">
												<div class="form-group has-success ">
													...
													<input class="form-control" placeholder="Calle" id="TrabajadorCalle" name="TrabajadorCalle" required="" type="text" value="">
												</div>
											</div>
											<div class="col-lg-6">
												<div class="form-group has-success ">
													<label for="">Villa / Población:</label>
													<input class="form-control" placeholder="Villa / Población" id="Trabajadorvilla" name="Trabajadorvilla"  type="text" value="">
												</div>
											</div>
											<div class="col-lg-6 col-md-6">
												<div class="form-group has-success ">
													<label for="">Numero:</label>
													<input class="form-control" placeholder="Numero" id="TrabajadorNumero" name="TrabajadorNumero" required="" type="text" value="">
												</div>
											</div>
											<div class="col-lg-6 col-md-6">
												<div class="form-group has-success ">
													<label for="">Departamento:</label>
													<input class="form-control" id="TrabajadorDepartamento" name="TrabajadorDepartamento" placeholder="Departamento" type="text" value="">
												</div>
											</div>
											<div class="col-lg-6">
												<div class="form-group select2-lg">
													<label for="">Región:</label>
													<select id="TrabajadorRegion" name="TrabajadorRegion" onchange="listarcomunas(), listarciudades()" required="" class="form-control regiones">
														<?php
											...
											<div class="col-lg-6">
												<div class="form-group select2-lg">
													...
													<select id="TrabajadorComuna" name="TrabajadorComuna" required="" class="form-control comunas">
											...
											<div class="col-lg-6">
												<div class="form-group select2-lg">
													...
													<select id="TrabajadorCiudad" name="TrabajadorCiudad" required="" class="form-control ciudades">
										...
										<div class="row">
											...
											<div class="col-lg-6">
												<div class="form-group has-success ">
													...
													<input id="TrabajadorTelefono" name="TrabajadorTelefono" required="" class="form-control" placeholder="Telefono" required="" type="text" value="">
												</div>
											</div>
											<div class="col-lg-6">
												<div class="form-group has-success ">
													<label for="">Correo Electronico:</label>
													<input class="form-control" id="TrabajadorCorreo" name="TrabajadorCorreo" required="" placeholder="Correo Electronico" required="" type="text" value="">
												</div>
											</div>
										</div>
										...
										<div class="col-md-12 mt-3 text-right">
											<a href="trabajadores.php" class="btn btn-danger btn-md"> <i class="fa fa-arrow-left"></i> Volver</a>
