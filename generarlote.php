...
<body class="main-body leftmenu">
				...
				<div class="inner-body">
					...
					<div class="page-header">
						<div class="page-header-1">
							<h1 class="main-content-title tx-30">Generar Contratos Masivos</h1>
							<ol class="breadcrumb">
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="card orverflow-hidden">
								<div class="card-body">
									<div>
										<h6 class="main-content-label mb-1">Seleccione los trabajadores</h6>
						...
						<div class="col-xl-6 col-lg-6 col-md-12">
							<div class="card transcation-crypto1" id="transcation-crypto1">
								<div class="card-header bd-b-0 d-flex justify-content-between">
									<h4 class="card-title font-weight-semibold mb-0">Listado Trabajadores</h4>
									<button onclick="agregartodo()" class="btn btn-info"><i class="fa fa-plus"></i> Todo</button>
								</div>
									...
									<div class="">
										<div class="table-responsive">
											<table class="table w-100 text-nowrap" id="example1">
												...
												<tbody>
													<?php
													$lista = $c->listartrabajadores($_SESSION['CURRENT_ENTERPRISE']);
													foreach ($lista as $object) {
														...
														echo "<a class='btn btn-outline-info btn-sm rounded-11' onclick='agregarlote(" . $object->getId() . ")' data-toggle='tooltip' data-original-title='Agregar al Lote'>";
							...
							<div class="card orverflow-hidden">
								<div class="card-body">
									<div class="d-flex justify-content-center">
										...
										<a href="contratosmasivos.php" class="btn btn-success">Generar Contratos <i class="fa fa-file"></i></a>
										<!-- Button de generar contratos masivos express -->
										<a href="contratosmasivosexpress.php" class="btn btn-primary ml-3">Generar Contratos Express <i class="fa fa-file"></i></a>
									</div>
								</div>
	...
	<script src="JsFunctions/generarlote.js"></script>
	<script>
