...
if($isapre != null){
    echo "<div class='row'>";
        ...
        echo "<div class='col-md-12'>";
        echo "<label>Tipo Institución</label>";
        echo "<select class='form-control' id='tipo'>";
        if($isapre->getTipo() == 1){
            echo "<option value='1' selected>FONASA</option>";
            echo "<option value='2'>ISAPRE</option>";
        }else{
            echo "<option value='1'>FONASA</option>";
            echo "<option value='2' selected>ISAPRE</option>";
        }
        echo "</select>";
        echo "</div>";
