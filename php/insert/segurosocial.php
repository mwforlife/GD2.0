...
if(isset($_POST['tabla']) && isset($_POST['fecha']) && isset($_POST['tasa'])){
    $tabla = $_POST['tabla'];
    ...
    try {
        // Llamar función del controlador para insertar
        $result = $c->registrarsegurosocial($nombreTabla, $codigo, $codigoPrevired, $fecha, $tasa);

        if($result == true){
            echo 1;
            // Registrar auditoría
            $usuario = $_SESSION['USER_ID'];
            $eventos = "Se registró tasa en " . $nombreTabla . " - Código: " . $codigo . ", Código Previred: " . $codigoPrevired . ", Fecha: " . $fecha . ", Tasa: " . $tasa;
