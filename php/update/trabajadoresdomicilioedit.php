...
if (isset($_POST['TrabajadorCalle']) && isset($_POST['Trabajadorvilla']) && isset($_POST['TrabajadorNumero']) && isset($_POST['TrabajadorRegion']) && isset($_POST['TrabajadorComuna']) && isset($_POST['TrabajadorCiudad']) && isset($_POST['id'])) {

    $calle = $_POST['TrabajadorCalle'];
    $calle = $c->escapeString($calle);
    $villa = $_POST['Trabajadorvilla'];
    $villa = $c->escapeString($villa);
    ...
    $id = $_POST['id'];
    $result = $c->actualizardomicilio($id,$calle,$villa, $numero, $departamento, $region, $comuna, $ciudad);
    if($result==true){
        echo 1;
