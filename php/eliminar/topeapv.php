...
$result = $c->eliminartopeapvmensual($id);

$usuario = $_SESSION['USER_ID'];

$periodo = $topeapvmensual->getPeriodo();
...
$periodo = $mes . " " . $anio;
$eventos = "Se elimino el TOPE AFP del Periodo ".$periodo . " con el tope: ".$topeapvmensual->getTasa() . " con el ID: ".$id;
