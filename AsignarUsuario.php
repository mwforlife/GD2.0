				...
				<div class="inner-body">
					...
					<div class="page-header">
						<div class="page-header-1">
							<h1 class="main-content-title tx-30">Asignar Usuarios</h1>
							<ol class="breadcrumb">
						...
						<div class="col-lg-12">
							<div class="card orverflow-hidden">
								<div class="card-header bd-b-0">
									<h4 class="card-title font-weight-semibold mb-0">Asignar Usuario</h4>
								</div>
								<div class="card-body">
									<div class="">
											...
											<table class="table w-100text-nowrap" id="example1">
												<thead class="border-top text-center">
													<tr>
														...
														<th class="bg-transparent text-center">Asignar</th>
													</tr>
												</thead>
												<tbody class="text-center">
													...
													foreach ($lista as $fila) {
														echo "<tr>";
														echo "<td>" . $fila->getRut() . "</td>";
														echo "<td>" . $fila->getNombre() . " " . $fila->getApellido() . "</td>";
														echo "<td><button class='btn btn-success' onclick='asignar(" . $fila->getId() . ", " . $id . ")'><i class='fa fa-check'></i></button></td>";
														echo "</tr>";
													}
													?>
												</tbody>
					...
					<div class="row">
						<div class="col-xl-12 col-lg-12 col-md-12">
							<div class="card transcation-crypto1" id="transcation-crypto1">
								<div class="card-header bd-b-0">
									<h4 class="card-title font-weight-semibold mb-0">Usuarios Asignados</h4>
								</div>
								<div class="card-body">
									<div class="">
										<div class="table-responsive">
											<table class="table w-100text-nowrap" id="example1">
												<thead class="border-top text-center">
													<tr>
														<th class="bg-transparent">ID</th>
														<th class="bg-transparent">Nombre</th>
														<th class="bg-transparent text-center">Estado</th>
													</tr>
												</thead>
												<tbody class="text-center">
													<?php
													$lista = $c->listarusuarioempresa($id);
													foreach ($lista as $fila) {
														echo "<tr>";
														echo "<td>" . $fila->getRut() . "</td>";
														echo "<td>" . $fila->getNombre() . " " . $fila->getApellido() . "</td>";
														if ($fila->getEstado() == 1) {
															echo "<td><button class='btn btn-success' onclick='cambiarestado(" . $fila->getId() . ",2)'><i class='fa fa-check'></i></button></td>";
														} else {
															echo "<td><button class='btn btn-danger' onclick='cambiarestado(" . $fila->getId() . ",1)'><i class='fa fa-times'></i></button></td>";
														}
														echo "</tr>";
													}
													?>
						...
						<div class="col-xl-12 col-lg-12 text-right">
							<a href="empresas.php" class="btn btn-danger"> <i class="fa fa-arrow-left"></i> Volver</a>
							<a href="empresas.php" class="btn btn-success"> <i class="fa fa-save"></i> Guardar</a>
						</div>
					</div>
					<!-- ROW-4 END -->
