...
if (count($lista) == 0) {
    header("Location: generarlotefiniquito.php");
}
                ...
                <div class="inner-body">
                    ...
                    <div class="row ">
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    <form id="formfiniquitomasivo" name="formfiniquitomasivo">
                                        <div class="row">
                                        ...
                                        <div class="col-md-12 mt-3 text-right">
                                            ...
                                            <button type="button" id="previafiniquitomasivo" class="btn btn-warning"> <i class="fa fa-eye"></i> Vista Previa</button>
