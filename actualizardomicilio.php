				...
				<div class="inner-body">
					...
					<div class="page-header">
						<div class="page-header-1">
							<h1 class="main-content-title tx-30">Editar Domicilio Trabajador</h1>
							<ol class="breadcrumb">
					...
					<div class="row">
						<div class="col-lg-12">
										<div class="card">
												<div class="card-body">
													<form id="DomicilioEditForm" name="DomicilioEditForm" action="" class="needs-validation was-validated">
														<div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="form-group has-success ">
                                                                <label for="">Calle:</label>
                                                                <input class="form-control" placeholder="Calle" id="TrabajadorCalle" name="TrabajadorCalle" required="" type="text" value="<?php echo $dom->getCalle();?>">
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <div class="form-group has-success ">
                                                                <label for="">Villa / Población:</label>
                                                                <input class="form-control" placeholder="Villa / Población" id="Trabajadorvilla" name="Trabajadorvilla" type="text" value="<?php echo $dom->getVilla();?>">
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6 col-md-6">
                                                            <div class="form-group has-success ">
                                                                <label for="">Numero:</label>
                                                                <input class="form-control" placeholder="Numero" id="TrabajadorNumero" name="TrabajadorNumero" required="" type="text" value="<?php echo $dom->getNumero();?>">
																<input id="id" name="id" required="" type="hidden" value="<?php echo $dom->getId();?>">
                                                        ...
                                                        <div class="col-lg-6 col-md-6">
                                                            <div class="form-group has-success ">
                                                                ...
                                                                <input class="form-control" id="TrabajadorDepartamento" name="TrabajadorDepartamento" placeholder="Departamento" type="text" value="<?php echo $dom->getDepartamento();?>">
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-6">
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group select2-lg">
                                                                ...
                                                                <select id="TrabajadorComuna" name="TrabajadorComuna" required="" class="form-control comunas">
                                                                    <?php
                                                                    $lista = $c->listarcomunas($dom->getRegion());
                                                                    if (count($lista) > 0) {
                                                                        foreach ($lista as $l) {
                                                                            if($l->getId() == $dom->getComuna()){
                                                                                echo "<option value='" . $l->getId() . "' selected>" . $l->getNombre() . "</option>";
                                                                            }else{
                                                                            echo "<option value='" . $l->getId() . "'>" . $l->getNombre() . "</option>";
                                                                            }
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="form-group select2-lg">
                                                                ...
                                                                <?php
                                                                    $lista = $c->listarciudades($dom->getRegion());
                                                                    if (count($lista) > 0) {
                                                                        foreach ($lista as $l) {
                                                                            if($l->getId() == $dom->getComuna()){
                                                                                echo "<option value='" . $l->getId() . "' selected>" . $l->getNombre() . "</option>";
