				...
				<div class="inner-body">
					...
					<div class="page-header">
						<div class="page-header-1">
							<h1 class="main-content-title tx-30">Editar Trabajador</h1>
							<ol class="breadcrumb">
					...
					<div class="row">
						<div class="col-lg-12">
										<div class="card">
												<div class="card-body">
													<form id="TrabajadorFormEdit" name="TrabajadorFormEdit" action="" class="needs-validation was-validated">
														<div class="row">
															<div class="col-lg-6">
																<div class="form-group has-success ">
																	<label for="">RUT:</label>
																	<input class="form-control" placeholder="RUT" maxlength="12" onkeyup="formatRut(this)" id="TrabajadorRut" name="TrabajadorRut" required="" type="text" value="<?php echo $trabajador->getRut(); ?>">
																</div>
															</div>
															<div class="col-lg-6">
																<div class="form-group has-success ">
																	<label for="">DNI:</label>
																	<input class="form-control" placeholder="DNI" id="TrabajadorDNI" name="TrabajadorDNI" type="text" value="<?php echo $trabajador->getDni(); ?>">
																</div>
															</div>
															<div class="col-lg-6">
																<div class="form-group has-success ">
																	<label for="">Nombre:</label>
																	<input class="form-control" placeholder="Nombre" id="TrabajadorNombre" name="TrabajadorNombre" required="" type="text" value="<?php echo $trabajador->getNombre(); ?>">
																</div>
															</div>
															<div class="col-lg-6">
																<div class="form-group has-success ">
																	...
																	<input class="form-control" placeholder="Primer Apellido" id="TrabajadorApellido1" name="TrabajadorApellido1" required="" type="text" value="<?php echo $trabajador->getApellido1(); ?>">
																</div>
															</div>
															<div class="col-lg-6">
																<div class="form-group has-success ">
																	<label for="">Segundo Apellido:</label>
																	<input class="form-control" placeholder="Segundo Apellido" id="TrabajadorApellido2" name="TrabajadorApellido2" type="text" value="<?php echo $trabajador->getApellido2(); ?>">
																</div>
															</div>
															<div class="col-lg-6">
																<div class="form-group has-success ">
																	<label for="">Fecha de Nacimiento:</label>
																	<input class="form-control" placeholder="Fecha de Nacimiento" id="TrabajadorNacimiento" name="TrabajadorNacimiento" required="" type="date" value="<?php echo $trabajador->getNacimiento(); ?>">
																</div>
															</div>
															<div class="col-lg-6">
														...
														<div class="col-md-12 mt-3 text-right">
															<a href="menuinfo.php" class="btn btn-danger btn-md"> <i class="fa fa-arrow-left"></i> Volver</a>
															<button type="submit" class="btn btn-primary btn-md"> <i class="fa fa-save"></i> Guardar Cambios</button>
														</div>
													</form>
											</div>
										</div>
