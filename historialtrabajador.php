											...
											<table class="table text-nowrap w-100" id="example1">
												<thead class="border-top">
													<tr>
														...
														<th class="bg-transparent text-center">Ver Ficha</th>
													</tr>
												</thead>
												<tbody>
													<?php
													...
													foreach ($lista as $object) {
														...
														echo "<a class='btn btn-outline-info btn-sm rounded-11' onclick='mas(" . $object->getId() . ")' data-toggle='tooltip' data-original-title='Ver Más'>";
