				...
				<div class="inner-body">
					...
					<div class="page-header">
						<div class="page-header-1">
							<h1 class="main-content-title tx-30">Actualizar Carga Familiar</h1>
							<ol class="breadcrumb">
					...
					<div class="row ">
						<div class="col-lg-12">
							<div class="card">
								<div class="card-body">
									<form id="CargaFormEdit" name="CargaFormEdit">
										<div class="row">
											<div class="col-md-6">
												<label>RUT</label>
												<input type="text" placeholder="11.111.111-1" required onkeyup="formatRut(this)" class="form-control text-dark text-dark" id="rut" name="rut" value="<?php echo $carga->getRut(); ?>">
											</div>
											<div class="col-md-6">
												<label>Nombres</label>
												<input type="text" placeholder="Nombres" required class="form-control text-dark text-dark" id="nombre" name="nombre" value="<?php echo $carga->getNombre(); ?>">
											</div>
											<div class="col-md-6">
												<label>Primer Apellido</label>
												<input type="text" placeholder="Primer Apellido" required class="form-control text-dark text-dark" id="apellido1" name="apellido1" value="<?php echo $carga->getApellido1(); ?>">
											</div>
											<div class="col-md-6">
												<label>Segundo Apellido</label>
												<input type="text" placeholder="Segundo Apellido" class="form-control text-dark text-dark" id="apellido2" name="apellido2" value="<?php echo $carga->getApellido2(); ?>">
											</div>
											<div class="col-md-6">
												<label>Fecha de Nacimiento</label>
												<input type="date" class="form-control text-dark text-dark" required id="nacimiento" name="nacimiento" value="<?php echo $carga->getFechaNacimiento(); ?>">
											</div>
											<div class="col-md-6">
												<label>Estado Civil</label>
												<select id="civil" name="civil" required="" class="form-control text-dark ">
													<?php
													$lista = $c->listarestadocivil();
													if (count($lista) > 0) {
														foreach ($lista as $l) {
															if ($l->getId() == $carga->getEstadoCivil()) {
											...
											<div class="col-md-6">
												...
												<input type="date" class="form-control text-dark text-dark" required id="reconocimiento" name="reconocimiento" value="<?php echo $carga->getFechaReconocimiento(); ?>">
											</div>
											<div class="col-md-6">
												<label>Fecha Pago</label>
												<input type="date" class="form-control text-dark text-dark" required id="pago" name="pago" value="<?php echo $carga->getFechaPago(); ?>">
											</div>
											<div class="col-md-6">
												<label>Vigencia Hasta</label>
												<input type="date" class="form-control text-dark text-dark" id="vigencia" name="vigencia" value="<?php echo $carga->getVigencia(); ?>">
												<input type="hidden" id="id" name="id" value="<?php echo $carga->getId(); ?>">
											</div>
											<div class="col-md-6">
												<div class="form-group select2-lg">
													<label for="">Tipo de Causante:</label>
													<select id="causante" name="causante" required="" class="form-control text-dark ">
														<?php
														$afps = $c->listartipocausante();
														if (count($afps) > 0) {
															foreach ($afps as $l) {
																if ($l->getId() == $carga->getTipoCausante()) {
																	echo "<option value='" . $l->getId() . "' selected>" . $l->getNombre() . "</option>";
																} else {
																	echo "<option value='" . $l->getId() . "'>" . $l->getNombre() . "</option>";
																}
															...
															echo "<option value='0'>No hay Causante Registrado</option>";
														}
														?>
													</select>
												</div>
											...
											<div class="col-md-6">
												<div class="form-group select2-lg">
													...
													<select id="sexo" name="sexo" required="" class="form-control text-dark ">
														<option value="1" <?php if ($carga->getSexo() == 1) {
																				echo "selected";
																			} ?>>Masculino</option>
														<option value="2" <?php if ($carga->getSexo() == 2) {
																				echo "selected";
																			} ?>>Femenino</option>
													</select>
												</div>
											...
											<div class="col-md-6">
												...
												<select class="form-control text-dark text-dark" required id="tramo" name="tramo">
													<?php
													$afps = $c->listartramosasignacionfamiliar();
													if (count($afps) > 0) {
														foreach ($afps as $l) {
															if ($l->getId() == $carga->getTipoCarga()) {
																echo "<option value='" . $l->getId() . "' selected>" . $l->getNombre() . "</option>";
															} else {
																echo "<option value='" . $l->getId() . "'>" . $l->getNombre() . "</option>";
															}
														...
														echo "<option value='0'>No hay Tramos Registradas</option>";
													}
													?>
												</select>
											</div>
													...
													<div class="card-body">
														...
														<div class="row">
															<div class="col-sm-12 col-md-12">
																<input class="form-control" maxlength="200" type="text" name="comentario" id="comentario" placeholder="Observacion" value="<?php echo $carga->getComentario(); ?>" />
															</div>
														</div>
													</div>
												</div>
												<div class="col-lg-12 col-md-12">
													<div class="card">
														<div class="card-body">
															...
															<div class="row">
																<div class="col-sm-12 col-md-12">
																	<input type="file" name="documento" id="documento" class="dropify" data-height="200" />
																</div>
															</div>
														</div>
													</div>
