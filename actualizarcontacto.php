				...
				<div class="inner-body">
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="card">
								<div class="card-body">
									<form id="ContactFormEditForm" name="ContactFormEditForm" action="" class="needs-validation was-validated">
										<div class="row">
											<div class="col-lg-6">
												<div class="form-group has-success ">
													<label for="">Telefono:</label>
													<input id="TrabajadorTelefono" name="TrabajadorTelefono" required="" class="form-control" placeholder="Telefono" required="" type="text" value="<?php echo $cont->getTelefono(); ?>">
													<input id="id" name="id" required="" type="hidden" value="<?php echo $cont->getId(); ?>">
												</div>
											</div>
											<div class="col-lg-6">
												<div class="form-group has-success ">
													<label for="">Correo Electronico:</label>
													<input class="form-control" id="TrabajadorCorreo" name="TrabajadorCorreo" required="" placeholder="Correo Electronico" required="" type="text" value="<?php echo $cont->getCorreo(); ?>">
												</div>
											</div>
