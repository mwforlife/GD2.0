...
<head>
    ...
    <!-- Title -->
    <title>Gestor de Documentos | SUELDO MÍNIMO</title>
...
<body class="main-body leftmenu">
                ...
                <div class="inner-body">
                    ...
                    <div class="page-header">
                        <div class="page-header-1">
                            <h1 class="main-content-title tx-30">Valor SUELDO MÍNIMO</h1>
                            <ol class="breadcrumb">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card orverflow-hidden">
                                <div class="card-body">
                                    <div>
                                        <h6 class="main-content-label mb-1">Registro de SUELDO MÍNIMO</h6>
                                    ...
                                    <form id="RegisForm" name="RegisForm" class="needs-validation was-validated">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group has-success mg-b-0">
                                                    <label>Tasa</label>
                                                    <input class="form-control" id="tasa" name="tasa" required="" type="text" value="" placeholder="Ingrese La Tasa">
                                                </div>
                                            </div>
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12">
                            <div class="card transcation-crypto1" id="transcation-crypto1">
                                <div class="card-header bd-b-0">
                                    <h4 class="card-title font-weight-semibold mb-0">Listado Valores SUELDO MÍNIMO</h4>
                                </div>
                                <div class="card-body">
                                    <div class="">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="staticBackdropLabel">Editar SUELDO MÍNIMO</h5>
                        ...
                        <form id="formedit">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group has-success mg-b-0">
                                        <label>Tasa</label>
                                        <input class="form-control" id="tasaedit" name="tasaedit" required="" type="text" value="" placeholder="Ingrese La Tasa">
                                    </div>
                                </div>
                                <div class="col-md-12 mt-3 text-right">
    ...
    <script>
        ...
        let myNumericInput = new AutoNumeric(('#tasa'), {
            decimalPlaces: 3,
            digitGroupSeparator: '.',
            decimalCharacter: ',',
            minimumValue: '0'
        ...
        document.querySelector('#tasa').addEventListener('keyup', function(event) {});
        
        myNumericInput = new AutoNumeric(('#tasaedit'), {
            decimalPlaces: 3,
            digitGroupSeparator: '.',
            decimalCharacter: ',',
            minimumValue: '0'
        ...
        document.querySelector('#tasaedit').addEventListener('keyup', function(event) {});
    }
    formatearnumero();
    </script>
    <script src="JsFunctions/sueldominimo.js"></script>
