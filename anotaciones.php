...
<body class="main-body leftmenu">
    ...
    <div class="page">
                ...
                <div class="inner-body">
                    ...
                    <div class="page-header">
                        <div class="page-header-1">
                            <h1 class="main-content-title tx-30">Registro de Anotaciones</h1>
                            <ol class="breadcrumb">
                    ...
                    <div class="row ">
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    <form id="formanotaciones" name="formanotaciones">
                                        <div class="row">
                                            <div class="col-lg-12 mt-3">
                                                <div class="form-group select2-lg">
                                                    <label for="">Tipo de Anotaciones:</label>
                                            ...
                                            <div class="col-lg-12 mt-1">
												...
												<textarea name="anotacion" id="anotacion" cols="30" rows="10" style="height: 400px !important;" class="form-control" required></textarea>
        ...
        <script src="JsFunctions/anotacion.js"></script>
