				...
				<div class="inner-body">
					...
					<div class="page-header">
						<div class="page-header-1">
							<h1 class="main-content-title tx-30">Auditoria de Trabajadores</h1>
							<ol class="breadcrumb">
					...
					<div class="card">
						<div class="card-header bd-b-0">
							<h4 class="card-title font-weight-semibold mb-0">Acciones</h4>
						</div>
						<div class="card-body">
							<div class="">
									...
									<table class="table w-100text-nowrap" id="example1">
										<thead class="border-top">
											<tr class="text-center">
												...
												<th class="bg-transparent">Movimiento Realizado</th>
											</tr>
										</thead>
										<tbody>
											<?php
											$lista = $c->listarAuditoriaEventos();
											if (count($lista) > 0) {
												foreach ($lista as $u) {
													echo "<tr class='border-bottom-0'>
                                                        ...
                                                        <td class='text-muted fs-15 font-weight-semibold'>" . $u->getFecha() . "</td>
                                                        <td class='text-muted fs-15 font-weight-semibold'>" . $u->getAccion() . "</td>";
													echo "</tr>";
												}
											}
											?>
