				...
				<div class="inner-body">
					...
					<div class="page-header">
						<div class="page-header-1">
							<h1 class="main-content-title tx-30 tx-uppercase">Tasa Caja Compensacion</h1>
							<ol class="breadcrumb">
								...
								<div class="card-body">
									<div>
                                        ...
                                        <div class="col-md-12 mt-3 text-right">
                                            <a class="btn btn-danger" href="cajacompensacion.php"> <i class="fa fa-arrow-left"></i> Volver</a>
						...
						<div class="col-xl-12 col-lg-12 col-md-12">
							<div class="card transcation-crypto1" id="transcation-crypto1">
								<div class="card-header bd-b-0">
									<h4 class="card-title font-weight-semibold mb-0">TASA CAJA COMPENSACIÓN</h4>
								</div>
								<div class="card-body">
									<div class="">
