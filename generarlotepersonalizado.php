...
<body class="main-body leftmenu">
                ...
                <div class="inner-body">
                    ...
                    <div class="page-header">
                        <div class="page-header-1">
                            <h1 class="main-content-title tx-30">Generar Documentos Masivos</h1>
                            <ol class="breadcrumb">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-12">
                                <div class="card transcation-crypto1" id="transcation-crypto1">
                                    <div class="card-header bd-b-0 d-flex justify-content-between">
                                        ...
                                        <button onclick="agregartodofiniquito(<?php echo $object->getId(); ?>)" class="btn btn-info"><i class="fa fa-plus"></i> Todo</button>
                                    </div>
                                                ...
                                                <table class="table w-100 text-nowrap table-lote" >
                                                    ...
                                                    <tbody>
                                                        ...
                                                        foreach ($lista1 as $object1) {
                                                            ...
                                                            echo "<a class='btn btn-outline-info btn-sm rounded-11' onclick='agregarlotefiniquito(" . $object1->getId() . ")' data-toggle='tooltip' data-original-title='Agregar al Lote'>";
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-12">
                            <div class="card transcation-crypto1" id="transcation-crypto1">
                                <div class="card-header bd-b-0 d-flex justify-content-between">
                                    ...
                                    <button onclick="Eliminarlotefiniquito()" class="btn btn-danger"><i class="fa fa-trash"></i> Todo</button>
                                </div>
                                <div class="card-body p-4">
                                    <div class="">
                                        <div class="table-responsive">
                            ...
                            <div class="card orverflow-hidden">
                                <div class="card-body">
                                    <div class="d-flex justify-content-center">
                                        <a href="documentospersonalizadosmasivos.php" class="btn btn-success">Generar Documentos <i class="fa fa-file"></i></a>
                                    </div>
                                </div>
    ...
    <script src="JsFunctions/lotesfiniquito.js"></script>
