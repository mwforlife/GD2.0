...
<head>
	...
	<!-- Title -->
	<title>Gestor de Documentos | Reporte de Movimientos</title>
				...
				<div class="inner-body">
					...
					<div class="page-header">
						<div class="page-header-1">
							<h1 class="main-content-title tx-30">Reporte de Movimientos</h1>
							<ol class="breadcrumb">
									...
									<div class="row">
										<div class="col-md-3">
											...
											if (isset($_SESSION['PERIODO_REPORTE'])) {
												$periodo = $_SESSION['PERIODO_REPORTE'];
											}
										...
										<table class="table table-hover w-100" id="example1">
											...
											<tbody>
												...
												foreach ($movimientos as $m) {
													...
													$mes = date("m", strtotime($m->getPeriodo()));
													$anio = date("Y", strtotime($m->getPeriodo()));
													switch ($mes) {
														case 1:
															$mes = "Enero";
															break;
