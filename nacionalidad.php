...
<body class="main-body leftmenu">
				...
				<div class="inner-body">
					...
					<div class="page-header">
						<div class="page-header-1">
							<h1 class="main-content-title tx-30">NACIONALIDADES</h1>
							<ol class="breadcrumb">
									...
									<form id="RegisForm" name="RegisForm" class="needs-validation was-validated">
										<div class="row">
											...
											<div class="col-lg-6">
												<div class="form-group has-success mg-b-0">
													<label>Nombre</label>
													<input class="form-control" id="Nombre" name="Nombre" placeholder="Nacionalidad" required="" type="text" value="">
												</div>
											</div>
	...
	<script src="JsFunctions/nacionalidad.js"></script>
