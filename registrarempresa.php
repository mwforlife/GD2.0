								...
								<div class="card-body">
									...
									<form name="EnterpriseForm" id="EnterpriseForm" class="needs-validation was-validated">
										...
										<div class="row">
											...
											<?php
											$mutual = $c->ultimatasamutual();
											$cotb = 0;
											$cotley = 0;
											if ($mutual != null) {
												$cotb = $mutual->getInstitucion();
												$cotley = $mutual->getTasa();
											}
											?>
											...
											<div class="col-lg-6 col-md-6">
												<div class="form-group has-success ">
													...
													<input class="form-control" name="EnterpriseCotizacionL" id="EnterpriseCotizacionL" placeholder="0" readonly required="" type="number" value="<?php echo $cotley; ?>">
												</div>
											</div>
											<div class="col-lg-6 col-md-12">
												<div class="form-group has-success ">
													<label for="">Cotización Adicional (%)</label>
													<input min="0" value="0" step="0.01" class="form-control" name="EnterpriseCotizacionC" id="EnterpriseCotizacionC" placeholder="Ingresar tasa" required="" type="number" value="">
												</div>
											</div>
