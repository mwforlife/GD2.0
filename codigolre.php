...
<body class="main-body leftmenu">
				...
				<div class="inner-body">
					...
					<div class="page-header">
						<div class="page-header-1">
							<h1 class="main-content-title tx-30">CODIGOS LRE</h1>
							<ol class="breadcrumb">
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="card orverflow-hidden">
								<div class="card-body">
									<div>
										<h6 class="main-content-label mb-1">Registro de codigo LRE</h6>
										...
										<div class="row">
											<div class="col-lg-6">
												<div class="form-group has-success mg-b-0">
													...
													<input class="form-control" id="articulo" name="articulo" placeholder="Ingrese el Articulo" type="text" value="">
												</div>
											</div>
											<div class="col-lg-6">
												<div class="form-group has-success mg-b-0">
											...
											<div class="col-lg-6">
												<div class="form-group has-success mg-b-0">
													...
													<input class="form-control" id="codigoprevired" name="codigoprevired" placeholder="Ingrese el Codigo Previred" type="text" value="">
												</div>
											</div>
											<div class="col-lg-6">
												<div class="form-group has-success mg-b-0">
													<label>Descripcion</label>
													<input class="form-control" id="Nombre" name="Nombre" placeholder="Ingrese la Descripción" required="" type="text" value="">
												</div>
											</div>
						...
						<div class="col-xl-12 col-lg-12 col-md-12">
							<div class="card transcation-crypto1" id="transcation-crypto1">
								<div class="card-header bd-b-0">
									<h4 class="card-title font-weight-semibold mb-0">Listado de Codigos LRE</h4>
								</div>
								<div class="card-body">
									<div class="">
										<div class="table-responsive">
											<table class="table w-100 text-nowrap" id="example1">
												<thead class="border-top text-center">
													<tr>
														<th class="bg-transparent">Articulo</th>
												...
												<tbody class="text-center">
													...
													?>
														<tr>
															<td><?php echo $codigo->getArticulo(); ?></td>
															<td><?php echo $codigo->getCodigo(); ?></td>
															<td><?php echo $codigo->getCodigoprevired(); ?></td>
															<td><?php echo $codigo->getDescripcion(); ?></td>
															<td>
																<button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modaledit" onclick="editarcodigolre('<?php echo $codigo->getId(); ?>')"><i class="fa fa-edit"></i></button>
																<button type="button" class="btn btn-danger btn-sm" onclick="eliminarcodigolre('<?php echo $codigo->getId(); ?>')"><i class="fa fa-trash"></i></button>
															</td>
														</tr>
													<?php
													}
	...
	<script src="JsFunctions/codigolre.js"></script>
