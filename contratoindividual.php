...
if (isset($_GET['code'])) {
	$trabajador = $_GET['code'];
	$tra = $c->buscartrabajador($trabajador);
	$emp = $c->buscarEmpresavalor($empresa);
	$dom = $c->ultimodomiciliotexto($trabajador);
	$con = $c->ultimocontacto($trabajador);
	$afp = $c->ultimaprevision($trabajador);
	if ($afp == false) {
		header("Location: infoprevisional.php");
	}
} else {
	header("Location: buscartrabajador.php");
}
...
<body class="main-body leftmenu">
								...
								<div class="card-body">
									...
									<form>
										...
										<div class="identificacion mt-4">
											...
											<div class="row">
												<div class="col-lg-12">
													<h3>Antecedentes del Trabajador/a</h3>
												</div>
											</div>
											<hr />
											<div class="row">
												...
												<div class="col-lg-6">
													<div class="form-group select2-lg">
														<label for="">RUT:</label>
														<input type="text" class="form-control text-dark" id="ruttrabajador" name="ruttrabajador" required="" value="<?php echo $tra->getRut(); ?>" readonly>
													</div>
												</div>
												<!--------------------------------------------------------->
												<!-----Nombres---------------------------------------------->
												<div class="col-lg-6">
													<div class="form-group select2-lg">
														...
														<input type="text" class="form-control text-dark" id="nombretrabajador" name="nombretrabajador" required="" value="<?php echo $tra->getNombre(); ?>" readonly>
													</div>
												</div>
												<!--------------------------------------------------------->
												<!-----Apellidos---------------------------------------------->
												<div class="col-lg-6">
													<div class="form-group select2-lg">
														...
														<input type="text" class="form-control text-dark" id="apellidos" name="apellidos" required="" value="<?php echo $tra->getApellido1() . " " . $tra->getApellido2(); ?>" readonly>
													</div>
												</div>
												<!--------------------------------------------------------->
												<!-----Fecha de Nacimiento---------------------------------------------->
												<div class="col-lg-6">
													<div class="form-group select2-lg">
														...
														<input type="text" class="form-control text-dark" id="fechanacimiento" name="fechanacimiento" required="" value="<?php
																																											//Cambio de formato de fecha a dd/mm/yyyy
																																											$fecha = $tra->getNacimiento();
												...
												<div class="col-lg-6">
													<div class="form-group select2-lg">
														...
														<input type="hidden" class="form-control text-dark" id="sexo" name="sexo" required="" value="<?php echo $tra->getSexo(); ?>" readonly>
														<label class="form-control"><?php if ($tra->getSexo() == 1) {
																						echo "Masculino";
																					} else {
																						echo "Feminino";
																					} ?></label>
												...
												<div class="col-lg-6">
													<div class="form-group select2-lg">
														...
														<input type="hidden" class="form-control text-dark" id="nacionalidad" name="nacionalidad" required="" value="<?php echo $tra->getNacionalidad(); ?>" readonly>
														<label class="form-control">
															<?php
															$nacio = $c->listarnacionalidad();
															foreach ($nacio as $object) {
																if ($object->getId() == $tra->getNacionalidad()) {
												...
												<div class="col-lg-6">
													<div class="form-group select2-lg">
														...
														<input type="text" class="form-control text-dark" id="correotrabajador" name="correotrabajador" required="" value="<?php echo $con->getCorreo(); ?>" readonly>
													</div>
												</div>
												<!--------------------------------------------------------->
												<!-----Teléfono---------------------------------------------->
												<div class="col-lg-6">
													<div class="form-group select2-lg">
														...
														<input type="text" class="form-control text-dark" id="telefonotrabajador" name="telefonotrabajador" required="" value="<?php echo $con->getTelefono(); ?>" readonly>
													</div>
												</div>
												<!-------------Region-------------------->
												<div class="col-lg-6">
													<div class="form-group select2-lg">
														<label for="">Región:</label>
														<input type="text" class="form-control text-dark" id="trabajadorregion" name="trabajadorregion" required="" value="<?php echo $dom->getRegion(); ?>" readonly>
													</div>
												</div>
												<!------------------------------------------->
												<!----------------Comuna-------------------->
												<div class="col-lg-6">
													<div class="form-group select2-lg">
														<label for="">Comuna:</label>
														<input type="text" class="form-control text-dark" id="trabajadorcomuna" name="trabajadorcomuna" required="" value="<?php echo $dom->getComuna(); ?>" readonly>
													</div>
												</div>
												<!--------------------------------------------------------->
												<!-----Calle---------------------------------------------->
												<div class="col-lg-6">
													<div class="form-group select2-lg">
														<label for="">Calle:</label>
														<input type="text" class="form-control text-dark" id="calletrabajador" name="calletrabajador" required="" value="<?php echo $dom->getCalle(); ?>" readonly>
													</div>
												</div>
												<!--------------------------------------------------------->
												<!-----Numero---------------------------------------------->
												<div class="col-lg-6">
													<div class="form-group select2-lg">
														<label for="">Numero:</label>
														<input type="text" class="form-control text-dark" id="numerotrabajador" name="numerotrabajador" required="" value="<?php echo $dom->getNumero(); ?>" readonly>
													</div>
												</div>
												<!--------------------------------------------------------->
												...
												<div class="col-lg-6">
													<div class="form-group select2-lg">
														<label for="">Depto. /Oficina (Optional):</label>
														<input type="text" class="form-control text-dark" id="departamentotrabajador" name="departamentotrabajador" value="<?php echo $dom->getDepartamento(); ?>" readonly>
													</div>
												</div>
											...
											<div class="row">
												...
												<div class="col-lg-12">
													<div class="form-group">
														<label class="custom-switch">
															<input type="checkbox" name="discapacidad" id="discapacidad" <?php if ($tra->getDiscapacidad() == 1) {
																																echo "checked";
																															} ?> class="custom-switch-input" disabled>
															<span class="custom-switch-indicator"></span>
															<span class="custom-switch-description">De Acuerdo con lo establecido en el Articulo 157 bits del Código del Trabajo. el Trabajador/a es persona con situación de discapacidad.</span>
														</label>
													</div>
												</div>
												<!--------------------------------------------------------->
												...
												<div class="col-lg-12">
													<div class="form-group">
														<label class="custom-switch">
															<input type="checkbox" name="pensionado" id="pensionado" <?php if ($tra->getPension() == 1) {
																															echo "checked";
																														} ?> class="custom-switch-input" disabled>
															<span class="custom-switch-indicator"></span>
															<span class="custom-switch-description">De Acuerdo con lo establecido en el Articulo 157 bits del Código del Trabajo. el Trabajador/a es asignatario de pensión de invalidez.</span>
														</label>
													</div>
												</div>
											</div>
											<div class="row">
												<div class="col-md-12 d-flex justify-content-between">
													<a href="buscartrabajador.php" class="btn btn-danger btn-sm pl-4 pr-4"><i class="fa fa-arrow-left"> Volver </i></a>
												...
												<div class="col-lg-6">
													<div class="form-group select2-lg">
														...
														<select id="Charge" name="Charge" required="" class="form-control text-dark" required>
															...
															<option value="Agente de mes de servicios (TIC-USUP)">Agente de mes de servicios (TIC-USUP)</option>
										...
										<div class="Remuneraciones mt-4 d-none">
											...
											<div class="row">
												...
												<?php
												$cuentabancaria = $c->ultimacuentabancariaregistrada($_GET['code']);
												if ($cuentabancaria == false) {
													echo "<div class='col-lg-6 text-center d-none trans'>";
													echo "<div class='alert alert-danger' role='alert'>
																No tiene cuenta bancaria registrada, por favor registre una cuenta bancaria para poder realizar pagos.</br>
																<a href='cuentabancaria.php' class='btn btn-primary'>Registrar Cuenta Bancaria</a>
																</div>";
													echo "</div>";
												} else {
												?>
													<div class="col-lg-6 d-none trans">
														<div class="form-group">
															...
															<select id="banco" name="banco" class="form-control">
																...
																if (count($afps) > 0) {
																	foreach ($afps as $l) {
																		if ($cuentabancaria->getBanco() == $l->getId()) {
													...
													<div class="col-lg-6 d-none trans">
														<div class="form-group">
															...
															<input type="text" id="numerocuenta" name="numerocuenta" class="form-control" placeholder="Numero de Cuenta" value="<?php if ($cuentabancaria != false) {
																																													echo $cuentabancaria->getNumero();
																																												} ?>">
														</div>
													</div>
												<?php
													...
													<div class="form-group select2-lg">
														...
														<select id="tipojornada" onchange="tipochange()" name="tipojornada" required="" class="form-control text-dark excluidoselect">
															...
															if (count($lista) > 0) {
																...
																echo "<option value='0'>No hay Jornada Disponible</option>";
															}*/
												...
												<div class="col-lg-12 general excluido">
													<table class="table w-100 table-bordered">
														...
														<tbody>
															<tr>
																<td>Distribución</td>
																<td class="text-center"><input onclick="calcularnormal(),todoonclick()" type="checkbox" id="todo"></td>
																<td class="text-center"><input onclick="calcularnormal(),checktodo1()" type="checkbox" class="dias1" id="dias11"></td>
																<td class="text-center"><input onclick="calcularnormal(),checktodo1()" type="checkbox" class="dias1" id="dias12"></td>
																<td class="text-center"><input onclick="calcularnormal(),checktodo1()" type="checkbox" class="dias1" id="dias13"></td>
																<td class="text-center"><input onclick="calcularnormal(),checktodo1()" type="checkbox" class="dias1" id="dias14"></td>
																<td class="text-center"><input onclick="calcularnormal(),checktodo1()" type="checkbox" class="dias1" id="dias15"></td>
																<td class="text-center"><input onclick="calcularnormal(),checktodo1()" type="checkbox" class="dias1" id="dias16"></td>
																<td class="text-center"><input onclick="calcularnormal(),checktodo1()" type="checkbox" class="dias1" id="dias17" disabled></td>
															</tr>
															<tr>
																<td>Hora de Inicio</td>
																<td class="text-center"><input type="time" onchange="changetimeinit1(),calcularnormal()" min="08:00" step="1" value="08:00" class="hora1" id="hora10"></td>
																<td class="text-center"><input onchange="calcularnormal()" type="time" min="08:00" step="1" value="08:00" class="hora1" id="hora11"></td>
																<td class="text-center"><input onchange="calcularnormal()" type="time" min="08:00" step="1" value="08:00" class="hora1" id="hora12"></td>
																<td class="text-center"><input onchange="calcularnormal()" type="time" min="08:00" step="1" value="08:00" class="hora1" id="hora13"></td>
																<td class="text-center"><input onchange="calcularnormal()" type="time" min="08:00" step="1" value="08:00" class="hora1" id="hora14"></td>
																<td class="text-center"><input onchange="calcularnormal()" type="time" min="08:00" step="1" value="08:00" class="hora1" id="hora15"></td>
																<td class="text-center"><input onchange="calcularnormal()" type="time" min="08:00" step="1" value="08:00" class="hora1" id="hora16"></td>
																<td class="text-center"><input onchange="calcularnormal()" type="time" min="08:00" step="1" value="08:00" class="hora1" id="hora17"></td>
															</tr>
															<tr>
																<td>Hora de Término</td>
																<td class="text-center"><input type="time" onchange="changetimeend1(),calcularnormal()" min="08:00" step="1" value="08:00" class="horat1" id="horat10"></td>
																<td class="text-center"><input onchange="calcularnormal()" type="time" min="08:00" step="1" value="08:00" class="horat1" id="horat11"></td>
																<td class="text-center"><input onchange="calcularnormal()" type="time" min="08:00" step="1" value="08:00" class="horat1" id="horat12"></td>
																<td class="text-center"><input onchange="calcularnormal()" type="time" min="08:00" step="1" value="08:00" class="horat1" id="horat13"></td>
																<td class="text-center"><input onchange="calcularnormal()" type="time" min="08:00" step="1" value="08:00" class="horat1" id="horat14"></td>
																<td class="text-center"><input onchange="calcularnormal()" type="time" min="08:00" step="1" value="08:00" class="horat1" id="horat15"></td>
																<td class="text-center"><input onchange="calcularnormal()" type="time" min="08:00" step="1" value="08:00" class="horat1" id="horat16"></td>
																<td class="text-center"><input onchange="calcularnormal()" type="time" min="08:00" step="1" value="08:00" class="horat1" id="horat17"></td>
															</tr>
															<tr>
																<td colspan="7">Nota: Sr. Empleador, si usted marca "Todos" y se despliga una jornada superior a la maxima legal es su deber ajustarla a los topes legales respectivos.</td>
																<td colspan="2">Cantidad de Horas: <span id="jornadanor"></span></td>
															</tr>
												...
												<div class="col-lg-12 d-none matutino excluido">
													<table class="table w-100 table-bordered ">
														...
														<tbody>
															...
															<tr>
																<td colspan="7">Nota: Sr. Empleador, si usted marca "Todos" y se despliga una jornada superior a la maxima legar es su deber ajustarla a los topes legales respectivos.</td>
																<td colspan="2">Cantidad de Horas: <span id="jornadamat"></span></td>
															</tr>
												...
												<div class="col-lg-12  d-none tarde excluido">
													<table class="table w-100 table-bordered">
														...
														<tbody>
															...
															<tr>
																<td colspan="7">Nota: Sr. Empleador, si usted marca "Todos" y se despliga una jornada superior a la maxima legar es su deber ajustarla a los topes legales respectivos.</td>
																<td colspan="2">Cantidad de Horas: <span id="jornadatarde"></span></td>
															</tr>
												...
												<div class="col-lg-12  d-none noche excluido">
													<table class="table w-100 table-bordered">
														...
														<tbody>
															...
															<tr>
																<td colspan="7">Nota: Sr. Empleador, si usted marca "Todos" y se despliga una jornada superior a la maxima legar es su deber ajustarla a los topes legales respectivos.</td>
																<td colspan="2">Cantidad de Horas: <span id="jornadanoche"></span></td>
															</tr>
										...
										<tbody>
											...
											if (count($lista) > 0) {
												foreach ($lista as $codigo) {
													...
													$nombre = str_replace(" ", " ", $codigo->getNombre());
													...
													$nombre = str_replace(":", " ", $nombre);
													$nombre = str_replace(";", " ", $nombre);
													$nombre = str_replace("ª", " ", $nombre);
													$nombre = str_replace("º", " ", $nombre);
													$nombre = str_replace("¿", " ", $nombre);
													$nombre = str_replace("?", " ", $nombre);
	...
	<div class="modal fade" id="modalresumen" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
		<div class="modal-dialog modal-xl modal-dialog-centered">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="staticBackdropLabel">Resumen Zona Geografica</h5>
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
						<span aria-hidden="true">&times;</span>
					</button>
				</div>
				<div class="modal-body">
					<div class="card" id="transcation-crypto-1">
						<div class="card-body p-0 pt-1">
							<div class="row">
								<div class="col-md-4 resumenregion">

								</div>
								<div class="col-md-4 resumenprovincia">

								</div>
								<div class="col-md-4 resumencomuna">
	...
	<script src="JsFunctions/contrato.js"></script>
