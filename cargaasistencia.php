...
<head>
	...
	<!-- Title -->
	<title>Gestor de Documentos | Carga Asistencia</title>
				...
				<div class="inner-body">
					...
					<div class="page-header">
						<div class="page-header-1">
							<h1 class="main-content-title tx-30">Carga Asistencia</h1>
							<ol class="breadcrumb">
										...
										<div class="row">
											<div class="col-md-12">
												<div class="alert alert-info">
													Descargar el archivo de asistencia, completar los datos y subir
													el archivo. <a href="uploads/plantilla/asistencia.csv"
														class="btn btn-outline-info btn-sm rounded-11"> <i
											...
											<div class="col-lg-6">
												<div class="row">
													<div class="col-lg-12">
														...
														<input type="file" name="asistencia" id="asistencia" class="form-control" required accept=".csv">
													</div>
												</div>
											</div>
											<div class="col-md-12 text-right mt-2">
														<button type="submit" class="btn btn-success"><i class="fa fa-upload"></i> Cargar Asistencia</button>
