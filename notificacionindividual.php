...
if (isset($_GET['code'])) {
    ...
    header("Location: trabajadoresfiniquitados.php");
}
...
<body class="main-body leftmenu">
    ...
    <div class="page">
                ...
                <div class="inner-body">
                    ...
                    <div class="page-header">
                        <div class="page-header-1">
                            <h1 class="main-content-title tx-30">Notificación de termino de Contrato</h1>
                            <ol class="breadcrumb">
                    ...
                    <div class="row ">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-6 col-md-6">
                                            ...
                                            <p>
                                                <?php
                                                echo "RUT: " . $trabajador->getRut() . "<br>";
                                                echo "Nombre: " . $trabajador->getNombre() . " " . $trabajador->getApellido1() . " " . $trabajador->getApellido2() . "<br>";
                                                ?>
                                            </p>
                                        </div>
                                        <div class="col-sm-6 col-md-6">
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    <form id="formnotificacion" name="formnotificacion">
                                        <div class="row">
                                            <div class="col-lg-12 text-center">
                                                <h2>Información de Notificación</h2>
                                            </div>
                                            <div class="col-lg-12 col-md-12 mt-4">
                                                <label for="">Finiquito a Notificar</label>
                                                <select class="form-control" onchange="cargarinfo()" id="finiquito" name="finiquito">
                                                    <option value="0">Seleccione el Finiquito</option>
                                                    <?php
                                                    $contratos = $c->listarfiniquitotext($_GET['code']);
                                                    if (count($contratos) > 0) {
                                                        $conteo = 0;
                                                        foreach ($contratos as $contrato) {
                                                            echo "<option  value='" . $contrato->getId() . "'>" . $contrato->getFechafiniquito() . " - " . $contrato->getCausal() . "</option>";
                                                            $conteo++;
                                                        }
                                                    } else {
                                                        echo "<option value='0'>No hay Finiquitos Disponibles</option>";
                                                    }
                                                    ?>
                                                </select>
                                            ...
                                            <div class="col-lg-6 mt-1">
                                                ...
                                                <input type="date" class="form-control text-dark" id="fechanotificacion" name="fechanotificacion" required="">

                                            </div>
                                            <div class="col-md-12">
                                                <div class="row datefiniquito">
                                                    ...
                                                    <div class="card-body">
                                                        <div class="row">
                                                            <div class="col-sm-12 col-md-12">
                                                                <label for="">Causal de Derecho:</label>
                                                                <select class="form-control" name="causal">
                                                                    <option value="0">Seleccione el Causal de termino</option>
                                                                    <?php
                                                                    $causal = $c->listarcausalterminacioncontrato();
                                                                    if (count($causal) > 0) {
                                                                        foreach ($causal as $causal1) {
                                                                            echo "<option value='" . $causal1->getId() . "'>" . $causal1->getNombre() . "</option>";
                                                                        }
                                                                    } else {
                                                                        echo "<tr>";
                                                                        echo "<td> No hay Registradas </td>";
                                                                        echo "</tr>";
                                                                    }
                                                                    ?>
                                                                </select>
                                            ...
                                            <div class="col-lg-12 col-md-12 mt-1">
                                                <div class="card">
                                                    <div class="card-body">
                                                        <div class="row">
                                                            <div class="col-sm-12 col-md-12">
                                                                <label for="">Causal de hechos:</label>
                                                                <textarea class="form-control" name="causalhechos" maxlength="4000" style="height:'300px;'"></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="card mt-2">
                                                    <div class="card-body" id="tableresumen">
                                                        <div class="table-responsive">
                                                            <table class="table w-100 table-bordered table-striped table-hover">
                                                                <thead>
                                                                    <tr>
                                                                        <th>Tipo</th>
                                                                        <th>Descripción</th>
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td>Indemnización</td>
                                                                        <td>Indemnización por termino de contrato</td>
                                                                        <td>500000</td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                            ...
                                            <div class="col-lg-12 col-md-12 mt-1">
                                                <div class="card">
                                                    <div class="card-body">
                                                        <div class="row">
                                                            <div class="col-sm-12 col-md-12">
                                                                <label for="">Cotizaciones Previsional:</label>
                                                                <textarea class="form-control" name="cotipre" maxlength="2000" height="200" required>Por mandato legal, le informo que sus cotizaciones previsionales y de salud, están enteramente pagadas hasta el 31 de agosto de 2022, y las del mes de septiembre 2022, se pagarán dentro del plazo otorgado por el art. 19 del DL. 3.500.</textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="card-body">
                                                        <div class="row">
                                                            <div class="col-sm-12 col-md-6">
                                                                <label for="">Forma de Comunicación:</label><br />
                                                                <input type="radio" name="comunicacion" onclick="vista(1)" value="1" checked> <span>Personal</span>
                                                                <input type="radio" name="comunicacion" value="2" onclick="vista(2)"> <span>Carta Certificada</span>
                                                            </div>
                                                            <div class="col-sm-12 col-md-6 vista d-none">
                                                                <label for="">Oficinas de Correos desde donde donde se envió la carta certificada:</label>
                                                                <select class="form-control" name="comuna">
                                                                    <?php
                                                                    $comunas = $c->listartodaslascomunas();
                                                                    if (count($comunas) > 0) {
                                            ...
                                            <div class="col-lg-12 col-md-12 mt-1">
                                                <div class="card">
                                                    <div class="card-body">
                                                        <div class="row">
                                                            <div class="col-sm-12 col-md-12">
                                                                <label for="">Documentacion que acreditacion pago previsional:</label><br />
                                                                <input type="radio" name="acreditacion" value="1"> <span>Planilla Cotizaciones</span>
                                                                <input type="radio" name="acreditacion" value="2" checked> <span>Certificado Cotizaciones</span>
                                                                <input type="radio" name="acreditacion" value="3"> <span>No Corresponde Informar</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-lg-12 col-md-12 mt-1">
                                                <div class="card">
                                                    <div class="card-body">
                                                        <div class="row">
                                                            <div class="col-sm-12 col-md-12">
                                                                <label for="">Disposición y Pago de Finiquito:</label><br />
                                                                <input type="radio" name="texto" onclick="vistas(1)" value="1" checked> <span>WEB</span>
                                                                <input type="radio" name="texto" value="2" onclick="vistas(2)"> <span>Presencial</span>
                                                            </div>
                                                            <div class="col-sm-12 col-md-12 vista2 mt-2">
                                                                <label for="">Detalle:</label>
                                                                <textarea class="form-control" name="texto1" id="texto1" cols="30" rows="10">El documento del finiquito se encontrará disponible para vuestra revisión y firma en el portal web de la página de la Dirección del Trabajo desde el día xx de xx del año 2021, el pago del mismo se realizará en forma electrónica a través de dicha plataforma, siendo facultativo para usted realizar la suscripción y percibir el pago en la forma indicada. Podrá siempre optar por realizar la gestión de forma presencial ante Ministro de fe, por ende, en caso de no estar de acuerdo con la forma propuesta, deberá comunicarlo a la empresa. Asimismo, informamos, que al momento de suscribir el documento del finiquito Ud., podrá formular reserva de derechos, si así lo estima necesario.</textarea>
                                                            </div>
                                        ...
                                        <div class="col-md-12 mt-3 text-right">
                                            <a href="<?php echo $previous_page;?>" class="btn btn-danger"> <i class="fa fa-arrow-left"></i> Volver</a>
                                            <button type="button" id="previanotificacion" class="btn btn-warning"> <i class="fa fa-eye"></i> Vista Previa</button>
        ...
        <script src="JsFunctions/finiquito.js"></script>
