...
<head>
    ...
    <!-- Title -->
    <title>Gestor de Documentos | UTA</title>
...
<body class="main-body leftmenu">
                ...
                <div class="inner-body">
                    ...
                    <div class="page-header">
                        <div class="page-header-1">
                            <h1 class="main-content-title tx-30">Valor UTA</h1>
                            <ol class="breadcrumb">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card orverflow-hidden">
                                <div class="card-body">
                                    <div>
                                        <h6 class="main-content-label mb-1">Registro de UTA</h6>
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12">
                            <div class="card transcation-crypto1" id="transcation-crypto1">
                                <div class="card-header bd-b-0">
                                    <h4 class="card-title font-weight-semibold mb-0">Listado Valores UTA</h4>
                                </div>
                                <div class="card-body">
                                    <div class="">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="staticBackdropLabel">Editar UTA</h5>
    ...
    <script src="JsFunctions/uta.js"></script>
