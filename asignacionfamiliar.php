...
<body class="main-body leftmenu">
				...
				<div class="inner-body">
					...
					<div class="page-header">
						<div class="page-header-1">
							<h1 class="main-content-title tx-30">Tramos Asignación Familiar</h1>
							<ol class="breadcrumb">
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="card orverflow-hidden">
								<div class="card-body">
									<div>
										<h6 class="main-content-label mb-1">Registro de Tramos Asignación Familiar</h6>
									...
									<form id="RegisForm" name="RegisForm" class="needs-validation was-validated">
										<div class="row">
											...
											<div class="col-lg-6">
												<div class="form-group has-success mg-b-0">
													<label>Nombre</label>
													<input class="form-control" id="Nombre" name="Nombre" placeholder="Nombre Tramo" required="" type="text" value="">
												</div>
											</div>
						...
						<div class="col-xl-12 col-lg-12 col-md-12">
							<div class="card transcation-crypto1" id="transcation-crypto1">
								<div class="card-header bd-b-0">
									<h4 class="card-title font-weight-semibold mb-0">Listado Tramos Asignación Familiar</h4>
								</div>
								<div class="card-body">
									<div class="">
											...
											<table class="table w-100text-nowrap" id="example1">
												<thead class="border-top text-center">
													<tr>
														...
														<th class="bg-transparent">Tramo</th>
														<th class="bg-transparent text-center">Accion</th>
													</tr>
												</thead>
												<tbody class="text-center">
													<?php
													$lista = $c->listartramosasignacionfamiliar();
													if (count($lista) > 0) {
	...
	<script src="JsFunctions/tramos.js"></script>
