				...
				<div class="inner-body">
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="card">
								<div class="card-body">
									<form id="DomicilioEdit" name="DomicilioEdit" action="" class="needs-validation was-validated">
										<div class="row">
											<div class="col-lg-6">
												<div class="form-group has-success ">
													<label for="">Calle:</label>
													<input class="form-control" placeholder="Calle" id="TrabajadorCalle" name="TrabajadorCalle" required="" type="text" value="<?php if ($dom != false) {
																																													echo $dom->getCalle();
																																												} ?>">
												</div>
											</div>
											<div class="col-lg-6">
												<div class="form-group has-success ">
													...
													<input class="form-control" placeholder="Villa / Población" id="Trabajadorvilla" name="Trabajadorvilla" type="text" value="<?php if ($dom != false) {
																																													echo $dom->getVilla();
																																												} ?>">
												</div>
											</div>
											<div class="col-lg-6 col-md-6">
												<div class="form-group has-success ">
													...
													<input class="form-control" placeholder="Numero" id="TrabajadorNumero" name="TrabajadorNumero" required="" type="text" value="<?php if ($dom != false) {
																																														echo $dom->getNumero();
																																													} ?>">
												</div>
											</div>
											<div class="col-lg-6 col-md-6">
												<div class="form-group has-success ">
													...
													<input class="form-control" id="TrabajadorDepartamento" name="TrabajadorDepartamento" placeholder="Departamento" type="text" value="<?php if ($dom != false) {
																																															echo $dom->getDepartamento();
																																														} ?>">
												</div>
											</div>
											<div class="col-lg-6">
					...
					<div class="col-lg-12">
						<div class="card">
							<div class="card-body table-responsive">
								<table class="table" id="table-domicilio">
									<thead>
										<tr>
