...
<body class="main-body leftmenu">
	...
	<div class="page">
				...
				<div class="inner-body">
					...
					<div class="page-header">
						<div class="page-header-1">
							<h1 class="main-content-title tx-30 tx-uppercase">Tasa Mutual de Seguridad</h1>
							<ol class="breadcrumb">
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="card orverflow-hidden">
								<div class="card-body">
									<div>
										<h6 class="main-content-label mb-1">Registro de Tasa</h6>
                                        ...
                                        <div class="col-md-6">
                                            <label>Tasa Basica:</label>
                                            <input class="form-control" id="tasa1" placeholder="Ingrese la Tasa Basica">
                                        </div>
                                        <div class="col-md-6">
                                            <label>Tasa LeySanna:</label>
                                            <input class="form-control" id="tasa2" placeholder="Ingrese la Tasa Ley Sanna">
                                        </div>
                                        <input type="hidden" id="idins">
                                        <div class="col-md-12 mt-3 text-right">
                                            <a class="btn btn-danger" href="mutuales.php"> <i class="fa fa-arrow-left"></i> Volver</a>
                                            <button onclick="registrartasa()" class="btn btn-primary"><i class="fa fa-refresh"></i> Actualizar</button>
                                        </div>
										</div>
								</div>
							</div>
						...
						<div class="col-xl-12 col-lg-12 col-md-12">
							<div class="card transcation-crypto1" id="transcation-crypto1">
								<div class="card-header bd-b-0">
									<h4 class="card-title font-weight-semibold mb-0">TASA AFP</h4>
								</div>
								<div class="card-body">
									<div class="">
										<div class="table-responsive">
                                            <table class="table w-100 table-bordered table-striped" id="exampl1">
                                                <thead>
                                                    <tr>
                                                        <th>Periodo</th>
                                                        <th>Tasa Basica</th>
		...
		<!-- Tasa Modal -->
		<div class="modal fade" id="modaltasa" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="staticBackdropLabel">Tasa</h5>
						<button type="button" class="close" data-dismiss="modal" aria-label="Close">
							<span aria-hidden="true">&times;</span>
						</button>
					</div>
					<div class="modal-body">
						<div class="row">
							...
							<input type="hidden" id="idins">
							<div class="col-md-12 mt-3 text-right">
								<button onclick="registrartasa()" class="btn btn-primary"><i class="fa fa-save"></i> Registrar</button>
							</div>
						</div>
						<div class="row mt-4">
							<div class="col-md-12">
	...
	<script src="JsFunctions/Mutuales.js"></script>
    <script>
