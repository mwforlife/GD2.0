...
<body class="main-body leftmenu">
				...
				<div class="inner-body">
					...
					<div class="page-header">
						<div class="page-header-1">
							<h1 class="main-content-title tx-30">Registrar Centro de Costo</h1>
							<ol class="breadcrumb">
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="card orverflow-hidden">
								<div class="card-body">
									<div>
										<h6 class="main-content-label mb-1">Registro de Centro de Costo</h6>
									...
									<form id="RegisForm" name="RegisForm" class="needs-validation was-validated">
										<div class="row">
											...
											<div class="col-lg-6">
												<div class="form-group has-success mg-b-0">
													<label>Nombre</label>
													<input class="form-control" id="Nombre" name="Nombre" placeholder="Nombre Centro Costo" required="" type="text" value="">
												</div>
											</div>
											<input type="hidden" id="Region" name="Region" value="<?php echo $id ?>">
											<div class="col-md-12 mt-3 text-right">
												<a href="empresas.php" class="btn btn-danger btn-md text-white"><i class="fa fa-arrow-left"></i> Volver</a>
								...
								<div class="card-body">
									<div class="">
										<div class="table-responsive">
											<table class="tabletext-nowrap w-100" id="example1">
	...
	<script src="JsFunctions/centrocosto.js"></script>
