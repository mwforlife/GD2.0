                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="table-responsive">
                                                    <table class="table w-100 table-bordered text-nowrap mb-0">
                                                        <thead>
                                                            <tr>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 text-right mt-2">
                                                <a href="usuarios.php" class="btn btn-danger btn-md"><i class="fa fa-arrow-left"></i> Volver</a>
                                                <a href="usuarios.php" class="btn btn-success btn-md"><i class="fa fa-save"></i> Guardar</a>
                                            </div>
                                    </div>
                                </div>
                            </div>
