						...
						<div class="col-xl-12 col-lg-12 col-md-12">
							<div class="card transcation-crypto1" id="transcation-crypto1">
								<div class="card-header bd-b-0">
									<h4 class="card-title font-weight-semibold mb-0">Listado Empresas</h4>
								</div>
											...
											<table class="table text-nowrap w-100" id="example1">
												<thead class="border-top">
													<tr>
														...
														<th class="bg-transparent text-center">Centro Costo</th>
														<th class="bg-transparent text-center">Cargos</th>
														<?php
														if ($_SESSION['GESTION_PERMISO'] == true) {
														?>
												...
												<tbody>
													...
													foreach ($lista as $object) {
														...
														echo "<a href='centrocosto.php?code=" . $object->getId() . "' class='btn btn-outline-success btn-sm rounded-11 mr-2' data-toggle='tooltip' data-original-title='Agregar Centro de Costo'>";
														echo "<i class='fa fa-home'></i>";
														echo "</a>";
														echo "</td>";
														echo "<td class='text-muted fs-15 font-weight-semibold text-center'>";
														echo "<a href='cargos.php?code=" . $object->getId() . "' class='btn btn-outline-success btn-sm rounded-11 mr-2' data-toggle='tooltip' data-original-title='Agregar Cargos'>";
