                ...
                <div class="inner-body">
                                                ...
                                                <table class="table w-100 text-nowrap">
                                                    <thead class="border-top">
                                                        <tr>
                                                            ...
                                                            <th class="bg-transparent">Fecha Finiquito</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody id="lotes">
                                                        <?php
                    ...
                    <div class="row ">
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    <form id="formnotificacionmasiva" name="formnotificacionmasiva">
                                        <div class="row">
                                        ...
                                        <div class="col-md-12 mt-3 text-right">
                                            <a href="generarlotenotificacion.php" class="btn btn-danger"> <i class="fa fa-arrow-left"></i> Volver</a>
                                            <button type="button" id="previanotificacionmasiva" class="btn btn-warning"> <i class="fa fa-eye"></i> Vista Previa</button>
