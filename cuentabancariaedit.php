...
if(isset($_GET['code'])){
	if($_GET['code']>0){
		$cuenta = $c->buscarcuentabancaria($_GET['code']);
		if($cuenta==false){
			header("Location: menuinfo.php");
		}
	}
									...
									<div class="row">
										<div class="col-md-12">
											<div class="alert alert-success">
												<strong>¡Genial!</strong> Estamos Actualizar la información Bancaria de <?php echo $trabajador->getNombre() ." ".$trabajador->getApellido1(). " ".$trabajador->getApellido2(); ?>
											</div>
										</div>
									</div>

									<form id="cuentabancariaformedit" name="cuentabancariaformedit">
										...
										<div class="row">
											...
											<input type="hidden" id="id" name="id" value="<?php echo $cuenta->getId(); ?>">
													...
													<div class="card-body">
														...
														<div class="row">
															<div class="col-sm-12 col-md-12">
																<input class="form-control" maxlength="200" type="text" name="numerocuenta" id="numerocuenta" value="<?php echo $cuenta->getNumero(); ?>" placeholder="Observacion" />
															</div>
														</div>
													</div>
												</div>
