...
<head>
    ...
    <!-- Title -->
    <title>Gestor de Documentos | TOPE APV ANUAL</title>
...
<body class="main-body leftmenu">
                ...
                <div class="inner-body">
                    ...
                    <div class="page-header">
                        <div class="page-header-1">
                            <h1 class="main-content-title tx-30">TOPE APV ANUAL</h1>
                            <ol class="breadcrumb">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="card orverflow-hidden">
                                <div class="card-body">
                                    <div>
                                        <h6 class="main-content-label mb-1">Registro de TOPE APV ANUAL</h6>
                                    ...
                                    <form id="RegisForm" name="RegisForm" class="needs-validation was-validated">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group has-success mg-b-0">
                                                    <label>TOPE</label>
                                                    <input class="form-control" id="tope" name="tope" required="" type="text" value="" placeholder="Ingrese el Tope">
                                                </div>
                                            </div>
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12">
                            <div class="card transcation-crypto1" id="transcation-crypto1">
                                <div class="card-header bd-b-0">
                                    <h4 class="card-title font-weight-semibold mb-0">Listado  TOPE APV ANUAL</h4>
                                </div>
                                <div class="card-body">
                                    <div class="">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="staticBackdropLabel">Editar TOPE APV ANUAL</h5>
                        ...
                        <form id="formedit">
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group has-success mg-b-0">
                                    <label>Año</label>
                                    <select class="form-control select2" id="periodoedit" name="periodoedit" required="">
                                                        <?php
                                                        $anoactual = date("Y");
                                                        for ($i = 1923; $i <= $anoactual; $i++) {
                                                            if($i == $anoactual) {
    ...
    <script src="JsFunctions/topeapvanual.js"></script>
