...
if (isset($_GET['code'])) {
    $id = $_GET['code'];
    if($id==0){
        header("Location: trabajadoresactivos.php");
        return;
    }
                ...
                <div class="inner-body">
                    ...
                    <div class="page-header">
                        <div class="page-header-1">
                            <h1 class="main-content-title tx-30">Finiquito</h1>
                            <ol class="breadcrumb">
                    ...
                    <div class="row ">
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    <form id="formfiniquitop" name="formfiniquitop">
                                        <div class="row">
                                            <div class="col-lg-12 text-center">
                                                <h2>Información de Finiquito</h2>
                                            </div>
                                            <div class="col-lg-12 col-md-12 mt-4">
                                                <label for="">Contrato a Finiquitar</label>
                                                <select class="form-control" onchange="cargarfecha()" id="contrato" name="contrato">
                                                    <option value="0">Seleccione el Contrato</option>
                                                    <?php
                                                        ...
                                                        foreach ($contratos as $contrato) {
                                                            if ($contrato->getEstado() == 1) {
                                                                if (strlen($contrato->getFechaTermino()) == 0) {
                                                                    $contrato->setFechaTermino("Sin Fecha de Termino");
                                                                }
                                                                echo "<option  value='" . $contrato->getId() . "'>" . $contrato->getTipoContrato() . " - " . $contrato->getFechaInicio() . "-   " . $contrato->getFechaTermino() . "</option>";
                                                                $conteo++;
                                                            }
                                                        }
                                                        if ($conteo == 0) {
                                                            echo "<option value='0'>No hay contratos activos</option>";
                                                        }
                                                    } else {
                                                        echo "<option value='0'>No hay contratos activos</option>";
                                                    }
                                            ...
                                            <div class="col-lg-6 mt-3">
                                                <div class="form-group select2-lg">
                                                    ...
                                                    <input type="hidden" class="form-control text-dark" id="trabajadorid" name="trabajadorid" required="" readonly value="<?php echo $_SESSION['TRABAJADOR_ID']; ?>">
                                                            ...
                                                            <div class="col-sm-12 col-md-12">
                                                                ...
                                                                <select class="form-control" name="causal">
                                                                    ...
                                                                    if (count($causal) > 0) {
                                                                        ...
                                                                        echo "<option value='0'>No hay causales</option>";
                                                                    }
                                                                    ?>
                                                                </select>
                                                            </div>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="row">
                                                    <div class="col-lg-3">
                                                        ...
                                                        <select class="form-control" id="tipo" name="tipo">
                                                            ...
                                                            if (count($causal) > 0) {
                                                                ...
                                                                echo "<option value='0'>No hay indemnizaciones Registradas</option>";
                                                            }
                                                            ?>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-3">
                                                        ...
                                                        <input type="text" class="form-control" name="monto" id="monto" placeholder="Ingrese el monto">
                                                    </div>

                                                    <div class="col-lg-2 d-flex justify-content-start align-items-end">
                                                        <button type="button" class="btn btn-success" onclick="registrarresumen()"> <i class="fa fa-plus"></i> Agregar</button>
                                                    </div>
                                                            ...
                                                            <table class="table table-bordered table-striped table-hover">
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td>500000</td>
                                                                        <td>
                                                                            <button class="btn btn-danger btn-sm fs-10" type="button" data-toggle="modal" data-target="#tipocontratomodal"><i class="fa fa-trash"></i></button>
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
                                        ...
                                        <div class="col-md-12 mt-3 text-right">
                                            ...
                                            <button type="button" id="previafiniquito" class="btn btn-warning"> <i class="fa fa-eye"></i> Vista Previa</button>
